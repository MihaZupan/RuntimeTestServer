...
public sealed class VerifyUploadHandler
{
    public static async Task InvokeAsync(HttpContext context)
    {
        ...
        if (string.IsNullOrEmpty(expectedHash))
        {
            ...
            context.SetStatusDescription("Missing 'Content-MD5' request header");
            return;
        }
        ...
        {
            context.Response.StatusCode = 400;
            context.SetStatusDescription("Received request body fails MD5 checksum");
        }
    }
